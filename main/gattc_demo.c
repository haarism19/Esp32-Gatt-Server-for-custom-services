...
// Editing by Haaris for a server-client model of BLE over esp32 which a custom UUID services and characteristics
...
// Add your device UUID below

//#define REMOTE_SERVICE_UUID        {0xBC, 0x8A, 0xBF, 0x45, 0xCA, 0x05, 0x50, 0xBA, 0x40, 0x42, 0xB0, 0x00, 0x00, 0x14, 0x64, 0xF3}
//#define REMOTE_NOTIFY_CHAR_UUID    {0xBC, 0x8A, 0xBF, 0x45, 0xCA, 0x05, 0x50, 0xBA, 0x40, 0x42, 0xB0, 0x00, 0x01, 0x14, 0x64, 0xF3}

#define PROFILE_NUM      1
#define PROFILE_A_APP_ID 0
#define INVALID_HANDLE   0

// Enter your BLE server advertising name

static const char remote_device_name[] = "BLE";
...
// Added by Haaris for comparing 128 bit UUID

uint8_t char_uuid[ESP_UUID_LEN_128] = REMOTE_SERVICE_UUID;
...
static void gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ...
    case ESP_GATTC_SEARCH_RES_EVT: {
        ...
        if (srvc_id->id.uuid.len == ESP_UUID_LEN_128 && bt_compare_UUID128(srvc_id->id.uuid.uuid.uuid128 , char_uuid)) {
            ESP_LOGI(GATTC_TAG, "service found");
            get_server = true;
            gl_profile_tab[PROFILE_A_APP_ID].service_start_handle = p_data->search_res.start_handle;
            gl_profile_tab[PROFILE_A_APP_ID].service_end_handle = p_data->search_res.end_handle;
            //ESP_LOGI(GATTC_TAG, "UUID16: %x", srvc_id->id.uuid.uuid.uuid128);
        }
        break;
    }
